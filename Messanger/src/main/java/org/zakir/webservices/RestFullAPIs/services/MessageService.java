...
import org.zakir.webservices.RestFullAPIs.exception.DataNotFoundException;
...
public class MessageService {
	...
	public MessageService() {
		messages.put(1L, new Message(1, "Hellow World", "Zakir"));
		messages.put(2L, new Message(2, "Hellow Guyz", "Zakir"));
	}
